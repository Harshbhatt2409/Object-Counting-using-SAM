...
parser.add_argument("-dp", "--data_path", type=str, default=r'C:\Users\hbhat\Desktop\Harsh\Sem 2 2023\Research Project Part A\sam_for_counting-main\FSC147_384_V2', help="Path to the FSC147 dataset")
...
parser.add_argument("-mp",  "--model_path", type=str, default=r'C:\Users\hbhat\Desktop\Harsh\Sem 2 2023\Research Project Part A\sam_for_counting-main\sam_vit_h_4b8939.pth', help="path to trained model")
...
for im_id in pbar:
    ...
    new_masks = []
    for ma in masks:
        if ma['area'] < 0.5*img_area:
            new_masks.append(ma)
            # est=est-1
            if ma['area'] > 800*box_area[0]:
                est=est+int(ma['area']/box_area[0])
